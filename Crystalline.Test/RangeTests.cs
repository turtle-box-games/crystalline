...
namespace Crystalline.Test
{
    ...
    public class RangeTests
    {
        ...
        public void StartTest([Random(-500, 500, 5)] int start)
        {
        ...
        public void EndTest([Random(-500, 500, 5)] int end)
        {
        ...
        public void SameStartEndTest([Random(-500, 500, 5)] int start)
        {
        ...
        public void DoesNotContainValueBeforeTest([Random(-500, 500, 2)] int start, [Random(25, 50, 2)] int count,
        ...
        [Test(Description = "Test that a value can't be found in the range when it is outside.")]
        public void DoesNotContainValueAfterTest([Random(-500, 500, 2)] int start, [Random(25, 50, 2)] int count,
            [Random(0, 50, 2)] int offset)
        {
            var end   = start + count;
        ...
        public void DoesNotContainEndTest([Random(-500, 500, 2)] int start, [Random(25, 50, 2)] int count)
        {
            var end   = start + count;
            var range = new Range(start, end);
